...
class CodeReviewPipeline:
    ...
    def review_code(
        ...
        """
        pipeline_res = self.run(code, filename=filename, manual_override=manual_override)
...
def run_pipeline(
    ...
    return pipeline.run(code=code, filename=filename, manual_override=manual_override)
...
def review_code(
    ...
    pipeline = CodeReviewPipeline()
    return pipeline.review_code(code=code, filename=filename, manual_override=manual_override)
